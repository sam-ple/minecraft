...
# Degree list & cardinal directions
...
# Proper angular difference (e.g., 345 and 0 = 15°)
...
while True:
    ...
    # Constant actionbar reminder
    m.execute(f'title {player} actionbar {{"text":"🧭 Face {current_target_label}","color":"gold"}}')

    # Damage if more than ±15° from target
    diff = angular_difference(yaw, current_target_deg)
    if diff > 7.5:
