...
# ロビー（終了時の待機場所）
LOBBY_POS = "0 65 0"   # /setworldspawn で指定しておくと良い
                    ...
                    if len(parts) == 2:
                        ...
                        for line in lines:
                            if line.startswith(target + ":"):
                                ...
                                found = True
                        if not found:
                            m.chat(f"No advancements found for {target}")
                elif content.startswith("--help"):
                    help_texts = [
                        {"text": "--start : ゲーム開始\n", "color": "aqua", "bold": True},
                        {"text": "--stop : ゲーム終了\n", "color": "aqua", "bold": True},
                        {"text": "--settime <秒> : ゲーム時間設定\n", "color": "aqua", "bold": True},
                        {"text": "--status : 現在のゲーム時間を確認\n", "color": "aqua", "bold": True},
                        {"text": "--adv <プレイヤー名> : プレイヤーの進捗確認\n", "color": "aqua", "bold": True},
                        {"text": "--help : 使い方表示", "color": "aqua", "bold": True}
                    ]
